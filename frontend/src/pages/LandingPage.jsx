  ...
  return (
    <div className="landing-page">
        ...
        <div className="grid-2 align-center">
          <div className="hero-text">
            <h1 style={{ fontSize: '3.5rem', marginBottom: '24px' }}>
              ...
              <span style={{ color: 'var(--primary)' }}>{t('landing.hero_highlight')}</span>
            </h1>
      ...
      <section className="container mt-8 animate-fade-in delay-200" style={{ paddingTop: '80px' }}>
        <h2 className="text-center mb-8" style={{ fontSize: '2.5rem' }}>{t('landing.features_title')}</h2>
        <div className="grid-3">
          <div className="glass-card text-center">
            ...
            <h3 className="mb-4">{t('landing.feat1_title')}</h3>
          ...
          <div className="glass-card text-center">
            ...
            <h3 className="mb-4">{t('landing.feat2_title')}</h3>
          ...
          <div className="glass-card text-center">
            ...
            <h3 className="mb-4">{t('landing.feat3_title')}</h3>
      ...
      <section className="container mt-8 animate-fade-in delay-300" style={{ paddingTop: '80px', paddingBottom: '80px' }}>
        <h2 className="text-center mb-8" style={{ fontSize: '2.5rem' }}>{t('landing.team_title')}</h2>
        <div className="grid-3">
          {[
            { name: 'Kajsa', role: t('landing.role_comm') },
            { name: 'Monia', role: t('landing.role_biz') },
            { name: 'Noor', role: t('landing.role_tech') }
          ].map(member => (

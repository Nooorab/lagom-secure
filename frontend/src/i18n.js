  ...
  en: {
    translation: {
      ...
      "portal": {
        ...
        "btn_return_landing": "Close Secure Session",
        "fail_title_dynamic": "Action Required: Critical NIS2 Gaps Found",
        "fail_desc_prefix": "We detected critical compliance gaps in your submission. To protect your enterprise contract, please review the requirements below and select a remediation path.",
  ...
  sv: {
    translation: {
      ...
      "portal": {
        ...
        "btn_return_landing": "Stäng Säker Session",
        "fail_title_dynamic": "Åtgärd Krävs: Kritiska brister hittade",
        "fail_desc_prefix": "Vi upptäckte kritiska brister i din inlämning. För att skydda ditt företagskontrakt, vänligen granska kraven nedan och välj en åtgärdsplan.",
